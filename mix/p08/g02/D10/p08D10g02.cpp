...
///////initial conditions//////////////////////
   ...
   for(int i = 0; i <= N+1;i++){ //（4）
    ...
    double const g_s = 1.0/4; // Isy,相当于D/4 
...
//         if(ss>=800000&&ss%10==0)
	//		{
        ...
        if (((ss>=19000 && ss<=20000) || (ss>=190000 && ss<=200000)) && ss%100 == 0){
            char s3[255] = "v_p08D10g02_middle.txt";
            fp7 = fopen(s3,"a+");
            fprintf(fp7,"%.4f\n",v0[N_middle][N_middle]);
            fclose(fp7);
            char s4[255] = "v_Isyn_p08D10g02_sample.txt";
            fp8 = fopen(s4,"a+");
            fprintf(fp8,"%.4f %.4f\n",v0[N_middle/2][N_middle/2],Isy[N_middle/2][N_middle/2]);
            fclose(fp8);
        ...
        if(ss%(10000*100)==0){
            ...
            char s2[255];
                 ...
                 //scanf_s("%d",&ss);
            sprintf(s, "%dvp08D10g02.txt", ss/100);
            sprintf(s1, "%dnp08D10g02.txt", ss/100);
            sprintf(s2, "%dsp08D10g02.txt", ss/100);
