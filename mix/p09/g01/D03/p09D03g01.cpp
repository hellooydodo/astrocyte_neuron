...
//         if(ss>=800000&&ss%10==0)
	//		{
        ...
        if (((ss>=19000 && ss<=20000) || (ss>=190000 && ss<=200000)) && ss%100 == 0){
            char s3[255] = "v_p09D03g01_middle.txt";
            fp7 = fopen(s3,"a+");
            fprintf(fp7,"%.4f\n",v0[N_middle][N_middle]);
            fclose(fp7);
            char s4[255] = "v_Isyn_p09D03g01_sample.txt";
            fp8 = fopen(s4,"a+");
        ...
        if(ss%(10000*100)==0){
            ...
            char s2[255];
                 ...
                 //scanf_s("%d",&ss);
            sprintf(s, "%dvp09D03g01.txt", ss/100);
            sprintf(s1, "%dnp09D03g01.txt", ss/100);
            sprintf(s2, "%dsp09D03g01.txt", ss/100);
