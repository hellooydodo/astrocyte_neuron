...
//         if(ss>=800000&&ss%10==0)
	//		{
        ...
        /*if (ss>=1000000 && ss<=1100000 && ss%100 == 0){
            ...
            fclose(fp7);
            char s4[255] = "v_Isyn_GABAD05_sample.txt";
            fp8 = fopen(s4,"a+");
            fprintf(fp8,"%.4f %4f\n",v0[44][55],Isy[44][55]);
            fclose(fp8);
        ...
        /*if(ss%(10000*100)==0){
            ...
            char s2[255];
                 ...
                 //scanf_s("%d",&ss);
            sprintf(s, "%dvGABAD05.txt", ss/100);
            sprintf(s1, "%dnGABAD05.txt", ss/100);
            sprintf(s2, "%dsGABAD05.txt", ss/100);
    ...
    char s[255];
    sprintf(s,"nonsyn_D_4146.txt");
    fp1 = fopen(s,"a+");
    fprintf(fp1,"%.2f ",D);
    printf("D = %.2f ss = %d",D,ss);
    if (ss<= 600000){
    	fprintf(fp1,"nonsyn\n");
    	printf("nonsyn\n");
	} 
