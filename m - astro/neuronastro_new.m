...
theta_s=0.2;sigma_s=0.02;phi=1.15;r_IP3=58;
...
%     end
        ...
        f(i) = f(i-1) + (-f(i-1)./tau_Ca+(1-f(i-1))*kappa*(Ca(i-1)>Ca_th)*(Ca(i-1)-Ca_th))*dt; % (Ca(i-1)>Ca_th)*
