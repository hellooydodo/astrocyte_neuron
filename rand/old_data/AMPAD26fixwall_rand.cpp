...
double Vsyn = 0;//GABA的情况是-60，AMPA的情况是0
...
//         if(ss>=800000&&ss%10==0)
	//		{
        ...
        if(ss%(10000*100)==0){
            ...
            char s2[255];
                 //scanf_s("%d",&ss);
            sprintf(s, "%dvAMPAD026.txt", ss/100);
            sprintf(s1, "%dnAMPAD026.txt", ss/100);
            sprintf(s2, "%dsAMPAD026.txt", ss/100);
